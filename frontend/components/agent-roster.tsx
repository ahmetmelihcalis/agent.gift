...
export function AgentRoster({ agents }: AgentRosterProps) {
  return (
    <section>
      <div className="rounded-[28px] border border-[#1f3a68] p-5">
        <p className="text-2xl font-semibold tracking-[-0.03em] text-navy">Ajanlar</p>
        <div className="mt-4 space-y-3.5">
          {agents.map((agent) => (
            <article
              key={agent.id}
              className="rounded-[22px] border border-[#1f3a68] bg-[linear-gradient(180deg,rgba(255,255,255,1),rgba(248,248,246,0.96))] px-4 py-4 shadow-[0_8px_22px_rgba(15,23,42,0.03)] transition-all duration-300 ease-out"
            >
